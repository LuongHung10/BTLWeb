...
urlpatterns = [
    ...
    #change password
    path("change-password/", auth_views.PasswordChangeView.as_view(template_name = 'home/password_change_form.html'),name='password_change'),
    path("change-password/done/", auth_views.PasswordChangeDoneView.as_view(template_name = 'home/password_change_done.html'),name='password_change_done'),
